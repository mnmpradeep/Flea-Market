...
********** Update Profile ************
 ...
 Postconditions: moderator should be able to update his details
 Functionality of the module: moderator can update his details that were given during registration from admin
 Date last modified: 04/18/2017    */--%>
<%@ Page Language="C#" MasterPageFile="~/Moderator/ModeratorMasterPage.master" AutoEventWireup="true" CodeFile="UpdateProfile.aspx.cs" Inherits="Moderator_UpdateProfile" Title="UHCL Flea Market" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <table class="auto-style6">
        ...
        <tr>
            ...
            <td class="style14">
                <asp:TextBox ID="Txt_Fname" runat="server" Width="140px"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td class="style28" colspan="2">
                ...
                &nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                    Text="Save Changes" Width="101px" CssClass="auto-style1" Height="27px" />
                </td>
        </tr>
        <tr>
            <td class="style28" colspan="2">
