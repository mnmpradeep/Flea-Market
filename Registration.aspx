...
<%@ Page Language="C#" MasterPageFile="~/login.master" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Registration" Title="UHCL Flea Market" %>
        ...
        <tr>
            ...
            <td align="right" class="auto-style7">
                ...
                <asp:Button ID="Button1"  runat="server" onclick="Button1_Click" Text="Submit" 
                    Width="90px" Height="25px" ValidationGroup="a" BackColor="orange" BorderColor="Wheat" BorderStyle="Ridge"  />
